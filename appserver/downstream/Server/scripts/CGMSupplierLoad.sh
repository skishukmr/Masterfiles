...
SUPDIR=$ARBENV/catdata/SupplierCGM
SAPDATADIR=$ARBENV/Server/config/variants/SAP/partitions/LSAP/data
DATE=`date '+%Y%m%d%H%M%S'`
cd $SUPDIR
touch SupplierCGM.log
chmod 777 SupplierCGM.log
logfile=SupplierCGM.log


#if [ -x "MSC_Supplier_CGM_*.dat" ] 
#then
...
for f in MSC_Supplier_CGM_*.dat;do
...
for f1 in MSC_SupplierLocation_CGM_*.dat;do
echo "File $f1 picked up for merger" >> $logfile
sed -i '1d' $f1
...
cat $f1 >> SupplierLocation.del
echo "move the file  $f1 to archive once the merger is complete" >> $logfile
done
...
#Start :  SpringRelease_RSD 126 (FDD_126_1.0 / TDD_126_2.0)
`awk -F'|'  -v q='"' 'BEGIN {OFS=","} {print q $2 q,q $3 q, q $4 q, q $5 q, q $6 q, q $7 q,q $8 q,q $9 q,q $10 q, q $11 q, q $12 q, q $13 q, q $14 q,q $15 q,q $16 q,q $17 q, q $18 q, q $19 q, q $20 q,q $21 q, q $22 q, q $23 q, q $24 q, q $25 q, q $1 q}' $SUPLCSV > SAP_CSV_SupplierLocation.csv`
#End : SpringRelease_RSD 126 (FDD_126_1.0 / TDD_126_2.0)
