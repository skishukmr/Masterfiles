...
public class CatMFGSetInvoiceInfoFromOrder extends Action
{
	private static final String ClassName = "config.java.invoiceeform.vcsv2.CatMFGSetInvoiceInfoFromOrder";
    ...
    public void fire (ValueSource object, PropertyTable params)
    {
        ...
        for (int i = 0; i < size; i++) {
			...
			// Create a new header level tax line item and add it to the invoice
