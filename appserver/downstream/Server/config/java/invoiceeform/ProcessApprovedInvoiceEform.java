...
*/
public class ProcessApprovedInvoiceEform extends Action
{
      ...
      throws ActionExecutionException
    {
        ...
        Money totalInvoiced = (Money)
            eform.getFieldValue("TotalInvoiced");
        ...
        invoice.setFieldValue("Terms",
            ...
            // Get the Contract number if it was set
        ...
        for (int i = 0; i < size; i++) {
            ...
            pd.setPrice(
                (Money)eformLI.getFieldValue("Price"));
            ...
            //AUL-TBD : InvoiceOrderInfo changed to StatementOrderInfo
