 ...
 * -------------------------------------------------------------------------------
 * Returns TRUE only if LIPD.Price.Currency == SupplierLocation.Currency
 */
...
public class CatCurrencyMatchingSupplierLoc extends Condition {

	private static final String THISCLASS = "CatCurrencyMatchingSupplierLoc";
	...
	public static boolean matchingCurrency(Object object) {
		...
		if (CatConstants.DEBUG)
		    Log.customer.debug("CatCurrencyMatchingSupplierLoc *** isMatch?: " + isMatch);
		return isMatch;
	}


	public CatCurrencyMatchingSupplierLoc() {
		super();
	}
