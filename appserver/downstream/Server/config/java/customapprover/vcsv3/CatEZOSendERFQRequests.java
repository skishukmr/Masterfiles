package config.java.customapprover.vcsv3;
...
public class CatEZOSendERFQRequests extends CustomApproverDelegateAdapter
{
	private static final String ClassName = "CatEZOSendERFQRequests";
	...
	private static String EmailBCCAddresses = ResourceService.getString("cat.email.vcsv3", "eRFQ_NotificationBCCList");

	/*
	private static String EmailSubject = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationSubject");
	private static String EmailTextCatHeader = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailCatHeader");
	private static String EmailTextSeparator = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailSeparator");
	private static String EmailTextRFQHeader = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailRFQHeader");
	private static String EmailTextReqFields = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailReqFieldsComment");
	private static String EmailTextRequestedBy = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailRequestedBy");
	private static String EmailTextRequestorPh = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailRequestorPh");
	private static String EmailTextBuyer = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailBuyer");
	private static String EmailTextSupplier = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailSupplier");
	private static String EmailTextSuppAddress = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailSuppAddress");
	private static String EmailTextSuppEmail = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailSuppEmail");
	private static String EmailTextSuppFax = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailSuppFax");
	private static String EmailTextRequestedDate = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailRequestedDate");
	private static String EmailTextLineDetails = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailBodyLineDetails");
	private static String EmailTextItem = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailItem");
	private static String EmailTextQuantity = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailQuantity");
	private static String EmailTextDesc = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailDescription");
	private static String EmailTextUOM = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailUOM");
	private static String EmailTextPartNum = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailPartNumber");
	private static String EmailTextNeedByDate = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailNeedByDate");
	private static String EmailTextDisclaimer = Fmt.Sil("cat.email.vcsv3", "eRFQ_NotificationEmailDisclaimer");
	*/
	...
	{
		String emailSubject = Fmt.Sil(suppLocale, "cat.email.vcsv3", "eRFQ_NotificationSubject");
		//if (Log.customer.debugOn)
	...
	{
		String emailTextCatHeader = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailCatHeader");
		String emailTextSeparator = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailSeparator");
		String emailTextRFQShortDesc = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailRFQShortDirection");
		String emailTextReqRef = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailRequisitionRef");
		String emailTextRequestedBy = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailRequestedBy");
		String emailTextRequestorPh = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailRequestorPh");
		String emailTextBuyer = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailBuyer");
		String emailTextBuyerPh = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailBuyerPh");
		String emailTextBuyerEmail = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailBuyerEmail");
		String emailTextSupplier = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailSupplier");
		String emailTextSuppAddress = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailSuppAddress");
		String emailTextSuppEmail = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailSuppEmail");
		String emailTextSuppFax = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailSuppFax");
		String emailTextRequestedDate = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailRequestedDate");
		String emailTextLineDetails = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailBodyLineDetails");
		String emailTextItem = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailItem");
		String emailTextQuantity = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailQuantity");
		String emailTextDesc = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailDescription");
		String emailTextUOM = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailUOM");
		String emailTextPartNum = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailPartNumber");
		String emailTextNeedByDate = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailNeedByDate");
		String emailTextComment = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailComment");
		String emailTextCommentNum = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailCommentNum");
		String emailTextDisclaimer = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailDisclaimer");
		String emailTextThankYou = Fmt.Sil(suppLocale,"cat.email.vcsv3", "eRFQ_NotificationEmailThankYou");

		emailTextReqRef = emailTextReqRef + r.getUniqueName();

		User requestor = r.getRequester();

		// SDey, Ariba, Inc : In 9r1 we should not pass null to getPartitionedUser method.
		ariba.common.core.User partUserReq = null;
		if(requestor !=null)
		    partUserReq = ariba.common.core.User.getPartitionedUser(requestor, r.getPartition());

		User buyer = (User) r.getDottedFieldValue("eRFQBuyer");

		// SDey, Ariba, Inc : In 9r1 we should not pass null to getPartitionedUser method.
		ariba.common.core.User partUserBuy =null;
		if(buyer !=null)
		    partUserBuy = ariba.common.core.User.getPartitionedUser(buyer, r.getPartition());
