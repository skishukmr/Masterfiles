...
public class SetCloseDateForOldPO extends ScheduledTask {
    ...
    private static final String THISCLASS = "SetCloseDateForOldPO:";
	...
	public void run() throws ScheduledTaskException {
		...
		query = new String ("select DirectOrder from ariba.purchasing.core.DirectOrder where OrderedState=4 and UniqueName like 'D%'" );
