...
/*
 * This class is used to run the the monthly  UK Reports for 18 months
 * Lekshmi - Issue 1171- Scheduled task for generating UK Monthly Reports
 */
public class CATGenerateMonthlyUKRepots extends ScheduledTask {

	private String thisclass = "CATGenerateMonthlyUKRepots";
	...
	public void init(Scheduler scheduler, String scheduledTaskName,
		...
		setHashFromResourceFile("cat.monthlyukreport.util", monthlyhash);
	...
	public void run() throws ScheduledTaskException {
		...
		aqlToDate = new AQLDateLiteral(dateRange.getToDate().getNow());
		monthlyMethod();
	}
