/*******************************************************************************************************************************************
	...
	Description: Pushes PO to DW system for Perkins

	ChangeLog:
	Date		Name		History
	--------------------------------------------------------------------------------------------------------------
	9/14/2005 	Kingshuk	--Initial Development Pushes PO to DW system for Perkins
        ...
        try
        {
			...
			while(results.next())
        	{
				...
				try
				{
						...
						//Log.customer.debug( "Object Pushed....Receipt #...." + results.getString("UniqueName") );
