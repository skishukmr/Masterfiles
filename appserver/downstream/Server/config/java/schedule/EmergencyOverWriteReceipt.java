/*******************************************************************************************************************************************
	...
	Description: Changing the ActionFlag Receipt

	ChangeLog:
	Date		Name		Description
	--------------------------------------------------------------------------------------------------------------
	7/10/2005 	Kingshuk	Changing the ActionFlag Receipt
...
public class EmergencyOverWriteReceipt extends ScheduledTask
{
    private String inputFileName="EmergencyOverWriteReceipt.data";
    ...
    public void run() throws ScheduledTaskException
    {
        ...
        try
        {
			...
			while ((line = br.readLine()) != null)
			{
				...
				query1 = ("SELECT FROM ariba.receiving.core.Receipt WHERE ControlIdentifier like '" + controlid + "' and ControlDate = Date('" + controldt + "')");
    ...
    public EmergencyOverWriteReceipt()
    {
    }
