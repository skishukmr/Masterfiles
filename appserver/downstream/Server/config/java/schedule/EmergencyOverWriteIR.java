/*******************************************************************************************************************************************
	...
	Description: Changing the ActionFlag IR

	ChangeLog:
	Date		Name		Description
	--------------------------------------------------------------------------------------------------------------
	7/10/2005 	Kingshuk	Changing the ActionFlag IR
...
public class EmergencyOverWriteIR extends ScheduledTask
{
    private String inputFileName="EmergencyOverWriteIR.data";
    ...
    {
		ariba.base.core.Log.customer.debug("Beginning EmergencyOverwrite for PO program .....");
        ...
        try
        {
			...
			while ((line = br.readLine()) != null)
			{
				...
				query1 = ("SELECT FROM ariba.invoicing.core.InvoiceReconciliation WHERE ControlIdentifier like '" + controlid + "' and ControlDate = Date('" + controldt + "')");
