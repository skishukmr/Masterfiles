...
public class CatCSVRequisition_Print extends Requisition_Print {

    private static final String THISCLASS = "CatCSVRequisition_Print";
 ...
 //		     runPrintHook((Approvable)bo,out,userFields,out,locale);
    ...
    public CatCSVRequisition_Print() {
        super();
    }
