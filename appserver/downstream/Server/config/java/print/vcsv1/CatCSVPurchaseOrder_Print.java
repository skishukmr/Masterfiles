...
public class CatCSVPurchaseOrder_Print extends PurchaseOrder_Print {

    private static final String THISCLASS = "CatCSVPurchaseOrder_Print";
 ...
 //		     runPrintHook((Approvable)bo,out,userFields,out,locale);
    ...
    protected void printHTMLLineItems(LineItemCollection lic, PrintWriter out, Locale locale) {
        ...
        if (li != null) {
            CatCSVProcureLineItem_Print catPlip = new CatCSVProcureLineItem_Print();
                                ...
                                Locale locale)
   {
    ...
    public CatCSVPurchaseOrder_Print() {
        super();
    }
