...
public class CatMFGMARequest_Print extends ContractCoreApprovable_Print {

    private static final String THISCLASS = "CatMFGMARequest_Print";
    ...
    public CatMFGMARequest_Print() {
        super();
        Log.customer.debug("%s *** Finished calling CatMFGMARequest_Print super!", THISCLASS);
    }
