...
public class USSupplierHook implements ApprovableHook
{
       ...
       String s8;
        ...
        if((useform.getFieldValue("Action").toString() == "Deactivate Supplier") | useform.getFieldValue("Action").equals("Deactivate Supplier"))
        {
           ...
           /* message.setFrom(new InternetAddress("MSC_Supplier_eForm@cat.com"));
            ...
            //messageBodyPart.setText(Fmt.Sil("cat.vcsv1", "SupplierEformMessage",tmp,status,changes));
            //Multipart multipart = new MimeMultipart();
            //multipart.addBodyPart(messageBodyPart);
        //    tmp= tmp + ":" + s1 + uniqueName ;
            ...
            if(asnFlag.equals("true")) {
                ...
                reportFileZip = new File("/opt/msc1/arb821/Server/classes/extensions/Templates.zip");
                ListUtil.addElementIfAbsent(attachments,reportFileZip);
                 // messageBodyPart = new MimeBodyPart();
               // javax.activation.DataSource source = new FileDataSource("/opt/msc1/arb821/Server/classes/extensions/Templates.zip");
