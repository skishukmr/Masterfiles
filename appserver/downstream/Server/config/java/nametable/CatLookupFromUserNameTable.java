...
AQLQuery userQuery;
    public AQLQuery buildQuery(String field, String pattern) {
		...
		String queryText = "SELECT uu FROM ariba.user.core.User uu , ariba.common.core.User cu INCLUDE INACTIVE "+ "WHERE cu.\"User\"=uu";

		//String queryText = "SELECT uu FROM ariba.user.core.User uu  INCLUDE INACTIVE ";
