...
public class CatEZOeRFQLocaleNameTable extends AQLNameTable {

    private static final String ClassName = "CatEZOeRFQLocaleNameTable";
    ...
    public CatEZOeRFQLocaleNameTable() {
        super();
    }
}