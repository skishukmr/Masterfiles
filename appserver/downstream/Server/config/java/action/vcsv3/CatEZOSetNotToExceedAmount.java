...
public class CatEZOSetNotToExceedAmount extends Action
{
	private static final String ClassName = "CatEZOSetNotToExceedAmount";
	...
	public CatEZOSetNotToExceedAmount()
	{
		super();
	}
}