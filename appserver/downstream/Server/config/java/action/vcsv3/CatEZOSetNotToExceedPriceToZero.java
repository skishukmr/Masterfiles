...
public class CatEZOSetNotToExceedPriceToZero extends Action
{
	private static final String ClassName = "CatEZOSetNotToExceedPriceToZero";
	...
	public CatEZOSetNotToExceedPriceToZero()
	{
		super();
	}
}
